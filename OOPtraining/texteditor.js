...
function iBackgroundColor() {
    var bgcolor = document.getElelmentById("bg-color");
...
function iInsertHTML() {
    var html = prompt("Insert HTM here:", "");
...
function submit_form() {
    ...
    var theForm = document.getElementById("form");
    var cont = theForm.elements["myTextArea"].value = window.frames['richTextfield'].document.body.innerHTML;
